      ...
      <Page size="A4" style={classicStyles.page}>
        ...
        <View style={classicStyles.header}>
          <View style={classicStyles.companyBlock}>
            {data.company_name && (
              <Text style={classicStyles.companyName}>{data.company_name}</Text>
            )}
            {data.company_address && (
              <Text style={classicStyles.companyDetail}>
                {data.company_address}
              </Text>
            )}
            {data.company_email && (
          ...
          <View style={classicStyles.invoiceBlock}>
            ...
            <Text style={classicStyles.invoiceNumber}>
              {data.invoice_number}
            </Text>
            <Text style={classicStyles.invoiceMeta}>
        ...
        <View style={classicStyles.billedTo}>
          ...
          {data.client_name && (
            <Text style={classicStyles.clientName}>{data.client_name}</Text>
          )}
          {data.client_email && (
            <Text style={classicStyles.clientDetail}>{data.client_email}</Text>
          )}
          {data.client_address && (
            <Text style={classicStyles.clientDetail}>
              {data.client_address}
            </Text>
          )}
        </View>
        ...
        <View style={classicStyles.tableHeader}>
          <Text
            style={[
              classicStyles.tableHeaderText,
              classicStyles.colDescription,
            ]}
          >
            Description
          </Text>
          <Text style={[classicStyles.tableHeaderText, classicStyles.colQty]}>
            Qty
          </Text>
          <Text style={[classicStyles.tableHeaderText, classicStyles.colPrice]}>
            Unit Price
          </Text>
          <Text
            style={[classicStyles.tableHeaderText, classicStyles.colAmount]}
          >
            Amount
          </Text>
        </View>
        {data.items.map((item, i) => (
          <View key={i} style={classicStyles.tableRow}>
            ...
            <Text style={classicStyles.colPrice}>
              {formatCurrency(item.unit_price, data.currency)}
            </Text>
            <Text style={classicStyles.colAmount}>
              {formatCurrency(item.quantity * item.unit_price, data.currency)}
            </Text>
          </View>
        ))}
        ...
        <View style={classicStyles.totalsBlock}>
          <View style={classicStyles.totalsRow}>
            ...
            <Text style={classicStyles.totalsValue}>
              {formatCurrency(data.subtotal, data.currency)}
            </Text>
          </View>
          {data.tax_rate > 0 && (
            <View style={classicStyles.totalsRow}>
              <Text style={classicStyles.totalsLabel}>
                Tax ({data.tax_rate}%)
              </Text>
              <Text style={classicStyles.totalsValue}>
          ...
          <View style={classicStyles.totalFinal}>
            ...
            <Text style={classicStyles.totalFinalValue}>
      ...
      <Page size="A4" style={modernStyles.page}>
        ...
        <View style={modernStyles.accent}>
          ...
          <View style={modernStyles.accentMeta}>
            ...
            <Text style={modernStyles.accentText}>
              Issued: {formatDate(data.issued_date)}
            </Text>
            <Text style={modernStyles.accentText}>
              Due: {formatDate(data.due_date)}
        ...
        <View style={modernStyles.body}>
          ...
          <View style={modernStyles.addressRow}>
            <View style={modernStyles.addressBlock}>
              ...
              {data.company_name && (
                <Text style={modernStyles.addressName}>
                  {data.company_name}
                </Text>
              )}
              {data.company_address && (
                <Text style={modernStyles.addressLine}>
                  {data.company_address}
                </Text>
              )}
              {data.company_email && (
            ...
            <View style={modernStyles.addressBlock}>
              ...
              {data.client_name && (
                <Text style={modernStyles.addressName}>{data.client_name}</Text>
              )}
              {data.client_email && (
                <Text style={modernStyles.addressLine}>
                  {data.client_email}
          ...
          <View style={modernStyles.table}>
            <View style={modernStyles.tableHeader}>
              <Text
                style={[
                  modernStyles.tableHeaderText,
                  modernStyles.colDescription,
                ]}
              >
                Description
              </Text>
              <Text style={[modernStyles.tableHeaderText, modernStyles.colQty]}>
                Qty
              </Text>
              <Text
                style={[modernStyles.tableHeaderText, modernStyles.colPrice]}
              >
                Price
              </Text>
              <Text
                style={[modernStyles.tableHeaderText, modernStyles.colAmount]}
              >
                Amount
              </Text>
            </View>
            {data.items.map((item, i) => (
              <View
                key={i}
                style={
                  i % 2 === 1 ? modernStyles.tableRowAlt : modernStyles.tableRow
                }
              >
                <Text style={modernStyles.colDescription}>
                  {item.description}
                </Text>
                <Text style={modernStyles.colQty}>{item.quantity}</Text>
                <Text style={modernStyles.colPrice}>
                  {formatCurrency(item.unit_price, data.currency)}
                </Text>
          ...
          <View style={modernStyles.summaryBox}>
            ...
            {data.tax_rate > 0 && (
              <View style={modernStyles.summaryRow}>
                <Text style={modernStyles.summaryLabel}>
                  Tax ({data.tax_rate}%)
                </Text>
                <Text style={modernStyles.summaryValue}>
                  {formatCurrency(data.tax_amount, data.currency)}
            ...
            <View style={modernStyles.totalRow}>
              ...
              <Text style={modernStyles.totalValue}>
                {formatCurrency(data.total, data.currency)}
              </Text>
            </View>
          </View>
      ...
      <Page size="A4" style={minimalStyles.page}>
        <View style={minimalStyles.header}>
          ...
          <View style={minimalStyles.metaBlock}>
            ...
            <Text style={minimalStyles.metaLine}>
        ...
        <View style={minimalStyles.addressRow}>
          <View style={minimalStyles.addressBlock}>
            ...
            {data.company_name && (
              <Text style={minimalStyles.addressName}>{data.company_name}</Text>
            )}
            {data.company_address && (
              <Text style={minimalStyles.addressText}>
                {data.company_address}
              </Text>
            )}
            {data.company_email && (
          ...
          <View style={minimalStyles.addressBlock}>
            ...
            {data.client_name && (
              <Text style={minimalStyles.addressName}>{data.client_name}</Text>
            )}
            {data.client_email && (
              <Text style={minimalStyles.addressText}>{data.client_email}</Text>
            )}
            {data.client_address && (
              <Text style={minimalStyles.addressText}>
                {data.client_address}
        ...
        <View style={minimalStyles.tableHeader}>
          <Text
            style={[
              minimalStyles.tableHeaderText,
              minimalStyles.colDescription,
            ]}
          >
            Item
          </Text>
          <Text style={[minimalStyles.tableHeaderText, minimalStyles.colQty]}>
            Qty
          </Text>
          <Text style={[minimalStyles.tableHeaderText, minimalStyles.colPrice]}>
            Price
          </Text>
          <Text
            style={[minimalStyles.tableHeaderText, minimalStyles.colAmount]}
          >
            Total
          </Text>
        </View>
        {data.items.map((item, i) => (
          <View key={i} style={minimalStyles.tableRow}>
            ...
            <Text style={minimalStyles.colPrice}>
              {formatCurrency(item.unit_price, data.currency)}
            </Text>
            <Text style={minimalStyles.colAmount}>
              {formatCurrency(item.quantity * item.unit_price, data.currency)}
            </Text>
          </View>
        ))}
        ...
        <View style={minimalStyles.totalsBlock}>
          <View style={minimalStyles.totalsRow}>
            ...
            <Text style={minimalStyles.totalsValue}>
              {formatCurrency(data.subtotal, data.currency)}
            </Text>
          </View>
          {data.tax_rate > 0 && (
          ...
          <View style={minimalStyles.totalFinal}>
            ...
            <Text style={minimalStyles.totalValue}>
              {formatCurrency(data.total, data.currency)}
            </Text>
          </View>
        </View>
