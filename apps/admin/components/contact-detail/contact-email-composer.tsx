      ...
      void credentialsApi
        ...
        .then((res) => {
          ...
          if (email?.from_address) {
            const display = email.display_name
              ? `${email.display_name} <${email.from_address}>`
              : email.from_address;
    ...
    >
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4">
          ...
          {emailResult && (
            <div
              className={`p-3 rounded-md text-sm ${emailResult.success ? "bg-green-50 text-green-800 border border-green-200" : "bg-red-50 text-red-800 border border-red-200"}`}
            >
              {emailResult.message}
            </div>
          )}
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-amber-700 mt-1">
                    ...
                    <span className="font-medium">{contactEmail}</span> with
                    subject &quot;
        ...
        <div className="flex items-center justify-between px-5 py-4 border-t bg-muted rounded-b-lg">
          <div>
            {composeStep !== "write" && (
              <Button
                ...
                onClick={() =>
                  setComposeStep(
                    composeStep === "confirm" ? "preview" : "write",
                  )
                }
          ...
          <div className="flex gap-2">
            <Button variant="outline" onClick={onClose} disabled={sendingEmail}>
              Cancel
            </Button>
            {composeStep === "write" && (
              <Button
