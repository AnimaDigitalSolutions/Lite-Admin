...
export default function SitesPage() {
  ...
  const handlePermissionToggle = async (site: Site, scope: string) => {
    ...
    setSites((prev) =>
      prev.map((s) =>
        s.id === site.id ? { ...s, permissions: updated.join(",") } : s,
      ),
    );
    try {
            ...
            <CardContent className="space-y-3">
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setNewSite((p) => ({ ...p, domain: e.target.value }))
                    }
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setNewSite((p) => ({ ...p, description: e.target.value }))
                  }
                ...
                <CardContent className="flex items-start gap-4 p-4">
                  <div className="flex-1 min-w-0 space-y-2">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <button
                        onClick={() =>
                          void copyToClipboard(site.api_key, site.id)
                        }
                        ...
                        return (
                          ...
                          >
                            <input
                              ...
                              checked={checked}
                              onChange={() =>
                                void handlePermissionToggle(site, scope.value)
                              }
                              className="h-3.5 w-3.5 rounded border-border text-blue-600 cursor-pointer focus:ring-blue-500"
                            />
                            <span
                              className={`text-[11px] ${checked ? "text-foreground" : "text-muted-foreground"}`}
                            >
                              {scope.label}
                            </span>
                          </label>
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    <Toggle
                      ...
                      onChange={(v) => void handleToggle(site.id, v)}
                      size="sm"
                    />
                    <button
          ...
          <Card className="bg-muted">
            <CardHeader className="pb-2">
              ...
              <CardDescription className="text-xs">
                Add this header to your external contact/waitlist form
                submissions:
              </CardDescription>
            </CardHeader>
            <CardContent>
