...
const CONTACTS = [
  {
    ...
    project_type: "web",
    message: "Looking for a modern portfolio redesign with CMS integration.",
    status: "new",
  ...
  },
  {
    ...
    project_type: "mobile",
    message: "Need a cross-platform mobile app for our fintech startup.",
    status: "contacted",
  ...
  },
  {
    ...
    project_type: "web",
    message: "We need an LMS platform for our online courses.",
    status: "qualified",
  ...
  },
  {
    ...
    project_type: "erp",
    message:
      "Inventory management system for our organic produce supply chain.",
  ...
  },
  {
    ...
    message: "Architecture review for our microservices migration.",
    status: "won",
  ...
  },
  {
    id: "6",
    name: "David Park",
    email: "david@sparkui.dev",
    company: "Spark UI",
    project_type: "web",
    message: "Component library and design system for our SaaS product.",
    status: "reviewed",
  ...
  },
  {
    id: "7",
    name: "Lina Müller",
    email: "lina@autohaus.de",
    company: "AutoHaus Digital",
    project_type: "web",
    message: "E-commerce platform for automotive parts with configurator.",
    status: "new",
  ...
  },
  {
    id: "8",
    name: "Raj Patel",
    email: "raj@cloudnine.in",
    company: "CloudNine Solutions",
    project_type: "consulting",
    message: "AWS infrastructure audit and cost optimization.",
    status: "lost",
  ...
  },
  {
    id: "9",
    name: "Olivia Foster",
    email: "olivia@freshbrand.co",
    company: "Fresh Brand Agency",
    project_type: "web",
    message: "Landing pages for our Q2 campaign launch.",
    status: "contacted",
  ...
  },
  {
    id: "10",
    name: "Noah Bergström",
    email: "noah@nordictech.se",
    company: "Nordic Tech AB",
    project_type: "mobile",
    message: "IoT dashboard app for our smart home devices.",
    status: "qualified",
...
const SUBSCRIBERS = [
  ...
  {
    id: "7",
    email: "sofia@techmed.it",
    name: "Sofia Russo",
    tags: '["early-access","newsletter"]',
    signed_up_at: daysAgo(3),
    country: "IT",
    country_name: "Italy",
    city: "Milan",
    region: "Lombardy",
...
const MEDIA_ITEMS = [
  {
    ...
    storage_path: "/uploads/hero-banner.jpg",
  ...
  },
  {
    ...
    height: 800,
    mime_type: "image/jpeg",
    storage_path: "/uploads/team-photo.jpg",
  ...
  },
  {
    ...
    original_name: "product-mockup.png",
    project_name: "Portfolio",
    description: "SaaS dashboard mockup",
    file_size: 3200000,
    width: 1600,
    height: 900,
    mime_type: "image/png",
    storage_path: "/uploads/product-mockup.png",
    uploaded_at: daysAgo(10),
    url: "https://picsum.photos/seed/product/1600/900",
  },
  {
    id: "4",
    filename: "logo-dark.svg",
    original_name: "logo-dark.svg",
    project_name: "Branding",
    description: "Dark variant of the company logo",
    file_size: 15000,
    mime_type: "image/svg+xml",
    storage_path: "/uploads/logo-dark.svg",
    uploaded_at: daysAgo(8),
    url: "https://picsum.photos/seed/logo/400/400",
  },
  {
    id: "5",
    filename: "case-study-cover.jpg",
    original_name: "case-study-cover.jpg",
    project_name: "Portfolio",
    description: "Featured case study header image",
    file_size: 1950000,
    width: 1400,
    height: 700,
    mime_type: "image/jpeg",
    storage_path: "/uploads/case-study-cover.jpg",
    uploaded_at: daysAgo(5),
    url: "https://picsum.photos/seed/casestudy/1400/700",
  },
  {
    id: "6",
    filename: "testimonial-bg.jpg",
    original_name: "testimonial-bg.jpg",
    project_name: "Portfolio",
    ...
    height: 600,
    mime_type: "image/jpeg",
    storage_path: "/uploads/testimonial-bg.jpg",
    uploaded_at: daysAgo(3),
    url: "https://picsum.photos/seed/testimonial/1920/600",
  },
  {
    id: "7",
    filename: "proposal-template.pdf",
    original_name: "proposal-template.pdf",
    project_name: "Documents",
    description: "Client proposal template",
    file_size: 450000,
    mime_type: "application/pdf",
    storage_path: "/uploads/proposal-template.pdf",
  ...
  },
  {
    ...
    project_name: "Portfolio",
    description: "Short product walkthrough video",
    file_size: 8500000,
    width: 1280,
    height: 720,
    mime_type: "video/mp4",
    storage_path: "/uploads/product-demo.mp4",
...
const INVOICES = [
  {
    ...
    status: "paid",
    currency: "USD",
    issued_date: dateStr(45),
    due_date: dateStr(15),
    client_name: "Nexus Digital",
    client_email: "aiko@nexus.jp",
    client_address: "Tokyo, Japan",
    company_name: "Anima Digital",
    company_email: "hello@anima.dev",
    company_address: "123 Creative Blvd",
  ...
  },
  {
    ...
    status: "sent",
    currency: "USD",
    issued_date: dateStr(10),
    due_date: futureDateStr(20),
    client_name: "GreenLeaf Organics",
    client_email: "james@greenleaf.com",
    client_address: "Dublin, Ireland",
    company_name: "Anima Digital",
    company_email: "hello@anima.dev",
    company_address: "123 Creative Blvd",
    company_phone: "+1 555-0100",
    ...
    items: [
      {
        description: "ERP System Phase 1",
        quantity: 1,
        unit_price: 5000,
        amount: 5000,
      },
  ...
  },
  {
    ...
    status: "draft",
    currency: "EUR",
    issued_date: dateStr(2),
    due_date: futureDateStr(28),
    client_name: "AutoHaus Digital",
    client_email: "lina@autohaus.de",
  ...
  },
  {
    ...
    status: "overdue",
    currency: "USD",
    issued_date: dateStr(60),
    due_date: dateStr(30),
    client_name: "CloudNine Solutions",
    client_email: "raj@cloudnine.in",
    ...
    items: [
      {
        description: "AWS Infrastructure Audit",
        quantity: 1,
        unit_price: 2500,
        amount: 2500,
      },
...
const CAMPAIGNS = [
  {
    ...
    html_content:
      "<h1>Introducing Our New Platform</h1><p>We are excited to announce the launch of our brand new platform designed to streamline your workflow.</p>",
    text_content:
      "Introducing Our New Platform - We are excited to announce the launch of our brand new platform.",
  },
  {
    id: 2,
    ...
    html_content:
      "<h1>March Newsletter</h1><p>Here's what happened this month...</p>",
    text_content: "",
  },
  {
    id: 3,
    name: "Beta Access Invite",
    subject: "You're invited to try our beta",
    status: "sent",
    target_type: "tagged",
    target_tags: '["beta","early-access"]',
    sent_at: daysAgo(20),
    total_recipients: 45,
    delivered: 44,
    opened: 38,
    ...
    html_content:
      "<h1>You're Invited!</h1><p>As a valued early supporter, we're giving you exclusive access to our beta program.</p>",
    text_content:
      "You're Invited! As a valued early supporter, we're giving you exclusive access to our beta program.",
  },
];
...
const LOGS = [
  ...
  },
  {
    id: 2,
    action: "media.upload",
    details: "Uploaded proposal-template.pdf",
    ip_address: "192.168.1.10",
  ...
  },
  {
    ...
    details: "Changed contact #2 status to contacted",
    ip_address: "192.168.1.10",
  ...
  },
  {
    ...
    details: "Created invoice INV-2026-003",
    ip_address: "192.168.1.10",
    created_at: daysAgo(2),
  },
  {
    ...
    details: 'Sent campaign "Product Launch" to 156 recipients',
    ip_address: "192.168.1.10",
  ...
  },
  {
    ...
    details: "Exported 8 subscribers to CSV",
    ip_address: "192.168.1.10",
...
const demoRoutes: [RegExp, DemoHandler][] = [
  ...
  [
    /\/auth\/login$/,
    () => ({
      data: { user: DEMO_USER, accessToken: "demo", refreshToken: "demo" },
    }),
  ],
  [/\/auth\/logout$/, () => ({ success: true })],
  [
    /\/auth\/refresh$/,
    () => ({ data: { accessToken: "demo", refreshToken: "demo" } }),
  ],
    ...
    () => ({
      data: {
        contacts: {
          ...
          trend: makeTrend(90, 2, 2),
        },
        waitlist: {
          total: SUBSCRIBERS.length,
          recent: SUBSCRIBERS[SUBSCRIBERS.length - 1].signed_up_at,
          trend: makeTrend(90, 1, 1),
        },
        media: {
          total: MEDIA_ITEMS.length,
          recent: MEDIA_ITEMS[MEDIA_ITEMS.length - 1].uploaded_at,
        },
        system: {
          uptime: 864000,
          memory: { heapUsed: 78643200, heapTotal: 104857600, rss: 157286400 },
  ...
  [
    /\/admin\/submissions\/\d+\/notes\/\d+\/toggle$/,
    () => ({
      data: { id: 1, is_done: true, completed_at: new Date().toISOString() },
    }),
  ],
  [
    /\/admin\/submissions\/\d+\/notes\/\d+\/due$/,
    () => ({ data: { id: 1, due_at: null } }),
  ],
  [
    /\/admin\/submissions\/\d+\/notes\/\d+$/,
    (url) => {
      const contactId = url.match(/\/submissions\/(\d+)\//)?.[1] || "0";
      const noteId = parseInt(url.match(/\/notes\/(\d+)$/)?.[1] || "0");
      demoNotes[contactId] = (demoNotes[contactId] || []).filter(
        (n) => n.id !== noteId,
      );
      return { success: true };
    },
  ...
  [
    /\/admin\/submissions\/\d+\/notes$/,
    (url, _params, method, body) => {
      const contactId = url.match(/\/submissions\/(\d+)\//)?.[1] || "0";
      if (method === "post") {
        const b = (
  ...
  [
    ...
    () => new Blob(["demo"], { type: "application/zip" }),
  ],
  ...
  [
    /\/admin\/waitlist\/tags$/,
    () => ({ data: ["early-access", "beta", "newsletter", "updates"] }),
  ],
  [
  ...
  [
    /\/admin\/waitlist\/count-by-target$/,
    () => ({ data: { count: SUBSCRIBERS.length } }),
  ],
  [
    /\/admin\/waitlist\/preview-recipients$/,
  ...
  [
    ...
    () => ({ data: { invoice_number: "INV-2026-005" } }),
  ],
  [
    /\/admin\/invoices\/\d+$/,
    (url) => {
    ...
    (url) => {
      ...
      return {
        data: {
          ...
          name: "Site",
          domain: "example.com",
          api_key: "demo_key_" + Math.random().toString(36).slice(2, 10),
          is_active: true,
      ...
      const sites = [
        {
          ...
          name: "Portfolio Site",
          domain: "anima.dev",
          api_key: "sk_live_demo1234567890",
          is_active: true,
        ...
        },
        {
          id: 2,
          name: "Staging",
          domain: "staging.anima.dev",
          api_key: "sk_test_demo0987654321",
          is_active: true,
      ...
      if (method === "post") {
        ...
        return {
          data: {
            ...
            domain: b?.domain || "",
            api_key: "sk_live_" + Math.random().toString(36).slice(2, 14),
            is_active: true,
            created_at: new Date().toISOString(),
          },
        };
